    ...
    <div>
        ...
        <div class="sale-order-top" v-for="order in orders" :key="order.id">
            ...
            <div class="sale-order-operation">
                ...
                <router-link :to="`/wechat/sale_order/${order.no}`" class="sale-order-detail" v-if="order.type===2">订单详情</router-link>
                <router-link :to="`/wechat/recover_order/${order.no}`" class="sale-order-detail" v-if="order.type===1">订单详情</router-link>
            </div>
        </div>
    </div>
</template>
