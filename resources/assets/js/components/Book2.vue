        ...
        <div v-if="book">
            <div class="bd-top">
                ...
                <div class="bd-activity">
                    ...
                    <router-link tag="div" to="/wechat/scan" class="bd-activity-go">去卖书 <van-icon name="arrow" /></router-link>
                </div>
            </div>
            ...
            >
                <div class="bd-relations">
                    <router-link :to="{ path: `/wechat/book/${re.isbn}`}" class="bd-re-book" v-for="re in otherBooks" :key="re.id">
