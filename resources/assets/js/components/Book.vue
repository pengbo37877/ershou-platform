    ...
    <div v-if="book">
      <div class="bd-top">
        ...
        <div class="bd-activity">
          ...
          <router-link tag="div" to="/wechat/scan" class="bd-activity-go">
            去卖书
            <van-icon name="arrow" />
          </router-link>
        </div>
      ...
      <van-goods-action>
        <van-goods-action-mini-btn icon="shop-o" to="/wechat/shop" text="商店" />
...
export default {
  ...
  mounted: function() {
    ...
    this.getComments();
    this.start =dayjs().format('YYYY/MM/DD HH:mm:ss');
    this.viewBook()
    // this.start=new Date(ms*1000).Format("yyyy-MM-dd hh:mm:ss");
  },
  destory(){
