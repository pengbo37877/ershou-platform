  ...
  <div class="shop">
    <div class="bgTop">
      <div class="bgDiv box_cqh">
        <router-link tag="div" to="/pc/search" class="shopSearch">
          <div class="searchBox">
        ...
        <router-link
          class="getCoupon"
          to="/pc/myCoupons?from=newCoupon"
          tag="div"
      ...
      <div class="shopBanner">
        <div class="bannerBox">
          ...
          >
            ...
            <van-swipe-item>
              <router-link tag="div" to="/pc/myCoupons?from=newCoupon">
                <img src="/images/image/banner2.png"  />
              </router-link>
            </van-swipe-item>
            <van-swipe-item>
              <div>
                <img src="/images/image/banner3.png"  @click="a('https://mp.weixin.qq.com/s/qEF1vhPp8nfNgjfAKdQUSQ')"/>
              </div>
            </van-swipe-item>
          </van-swipe>
    ...
    <div class="hotBox">
      <div class="titleBox box_cqh">
        ...
        <div class="more" @click.stop="$router.push('/pc/hotBook')">
          全部
        ...
        <van-swipe :autoplay="5000" height="160" :show-indicators="false">
          <van-swipe-item>
            <router-link
              ...
              :key="index"
              v-if="index<10"
              :to="{path: `/pc/book/${book.isbn}?from=shop`}"
            >
    ...
    <!-- 4个分类 -->
    <div class="fourBox">
      <router-link class="fourMenu menu1" tag="div" to="/pc/newbook">
        <img src="/images/image/menu1.png" />
        <div>新书专区</div>
      </router-link>
      <router-link class="fourMenu menu2" tag="div" to="/pc/fourClassify/特价市集">
        <img src="/images/image/menu2.png" />
        <div>特价专区</div>
      </router-link>
      <router-link class="fourMenu menu3" tag="div" to="/pc/shudanAll">
        <img src="/images/image/menu3.png" />
        <div>推荐书单</div>
      </router-link>
      <router-link class="fourMenu menu4" tag="div" to="/pc/fourClassify/豆瓣8.5+">
...
export default {
  ...
  methods: {
    ...
    // },
    coupon: function() {
      this.$router.push("/pc/share_desc");
    },
    onLoad: function() {
      console.log("onLoad");
      // 异步更新数据
    ...
    gotoReadDay: function() {
      this.$router.push("/pc/read_day");
    },
    gotoCoupon() {
      this.showNewUserCoupon = false;
      this.$router.push("/pc/myCoupons?from=newCoupon");
    },
    getActivity() {
