<template>
    <div class="shop-item">
        <router-link tag="div" :to="{path: `/pc/book/${book.isbn}?from=shopbook`}" class="shop-book">
            ...
            <div class="shop-book-info">
                ...
                <div class="shop-book-sale-info" :style="saleInfo" v-if="skus.length===1">
                    ...
                    <router-link :to="`/pc/user/${prevUser.mp_open_id}`" class="shop-book-prev-user" v-if="prevUser">
