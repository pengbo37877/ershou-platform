  ...
  <div class="myBox">
    <div class="topBox">
      ...
      <div class="menu box_cqh">
        <router-link class="menuList" to="/pc/wallet" tag="div">
          <img src="/images/image/yue.png" alt width="25" height="25" />
          <div>余额</div>
        </router-link>
        <router-link class="menuList" to="/pc/my_orders" tag="div">
          <img src="/images/image/dingdan.png" alt width="25" height="25" />
          <div>订单</div>
        </router-link>
        <router-link class="menuList" to="/pc/myCoupons" tag="div">
          <img src="/images/image/juan.png" alt width="25" height="25" />
          <div>现金券</div>
          <div class="dian" v-show="showRemind"></div>
        </router-link>
        <router-link class="menuList" to="/pc/address_list?from=my" tag="div">
          ...
          <van-list :finished="true">
            <div class="bd-relations" v-if="shelfBooks.length>0">
              <div class="bd-re-book" v-for="book in shelfBooks" :key="book.id">
                <router-link :to="`/pc/book/${book.isbn}?from=my`" class="bd-re-book-cover">
