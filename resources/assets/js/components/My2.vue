<template>
    <div>
        ...
        <div class="my-buttons">
            <router-link to="/wechat/wallet" class="btn-a">
                余额
            </router-link>
            <router-link to="/wechat/my_orders" class="btn-a">
                订单
            </router-link>
            <!--<router-link to="/wechat/buy_sale_books" class="btn-a">-->
                <!--买卖的书-->
            <!--</router-link>-->
            <router-link to="/wechat/address_list?from=my" class="btn-a">
                地址管理
            </router-link>
        </div>
        <div class="my-buttons">
        ...
        <div class="my-books" v-if="nav===0">
            ...
            <div class="bd-relations">
                <div class="bd-re-book" v-for="book in shelfBooks" :key="book.id">
                    <router-link :to="`/wechat/book/${book.isbn}?from=my`" class="bd-re-book-cover" :style="reStyle">
