    ...
    protected function grid()
    {
        ...
        $grid->items('包含的书')->display(function ($items) {
            ...
            if ($this->type == Order::ORDER_TYPE_SALE) {
                ...
                $coupon = $this->coupon;
                if ($coupon) {
                    $priceDesc = '<span>共' . count($its) . '本</span>' .
